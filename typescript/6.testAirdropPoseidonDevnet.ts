...
async function main() {
    ...
    //    👇👇👇
    // modify with the Airdrop address resulting of 5.deployAirdropPoseidonDevnet.ts :
    const AIRDROP_ADDRESS = "0x1593c3a733fce488f149d03ddd1886882713f794feb314ba7dc98f2b020d8ec";
    //    👆👆👆
    const compiledTest = json.parse(fs.readFileSync("./compiledContracts/cairo240/airdrop_poseidon.sierra.json").toString("ascii"));
